  ...
  return (
    <>
      ...
      <div className="min-h-screen app-bg hidden md:flex flex-col">
        ...
        <div className="flex flex-1 items-center justify-center">
          <div className="w-[1240px] h-[808px] bg-transparent border mb-10 flex">
            ...
            <div className="md:w-[620px] md:h-[806px] shrink-0 relative">
              ...
              <div className="absolute top-6 right-8 z-10 w-[104px] h-[39px] bg-[#4693ED] rounded-[40px] flex items-center justify-center">
        ...
        <div className="hidden md:flex items-center justify-start mt-2 mb-25 ml-[120px] gap-8">
      ...
      >
        ...
        <div className="absolute top-6 right-15 w-[60px] h-[27px] bg-white/40 rounded-[10px] flex items-center justify-center gap-1">
          <IoEyeSharp className="text-white text-[15px]" />
          <span className="text-white text-[13px] satoshi-bold tracking-widest">
            295
          </span>
        </div>
        <div className="absolute top-6 right-32 w-[49px] h-[27px] bg-[#006CA2] rounded-[10px] flex items-center justify-center">
        ...
        <div className="absolute bottom-22 left-7 right-1 w-[80%] max-h-[250px] overflow-y-auto flex flex-col gap-1 no-scrollbar">
          {livebidMessages.map((msg) => (
            <ChatMessage
              key={msg.id}
              profileImg={msg.profileImg}
        ...
        <div className="absolute bottom-6 left-6 ">
          <div className="w-[302px] h-[50px] flex items-center px-4 bg-transparent rounded-[30px] border border-white">
            <input
              type="text"
